...
인텔리전스 기반 C2 차단	Anubis (Sphinx) 랜섬웨어 공격 인프라 🛡️ (Remotely C2, MeshAgent C2, Typosquatted ScreenConnect Relay, MEGA S4 Exfiltration Path)
...
YARA
APT / 공급망 공격 ⚠️	**북한 해커 조직 (Contagious Interview)**의 개발자 타깃 오픈소스 공급망 공격 (PolinRider 캠페인 악성 패키지 SHA-256 탐지)
